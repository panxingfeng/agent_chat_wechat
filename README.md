...
- (已完成)工具支持(描述信息可以使用 工具.get_description查看功能)
    ...
    - 提示词模板工具(awesome-chatgpt-prompts):参考项目:[awesome-chatgpt-prompts](https://github.com/panxingfeng/awesome-chatgpt-prompts) [控制台输出结果1](./images/prompt_result1.png)[控制台输出结果2](./images/prompt_result2.png)
