...
4.基于react的网站框架代码，实现文字的流式输出(自动识别格式进行可视化的模板输出)，文生图/图生图（基于SD-webui的api(整体代码已实现，见[SD-on-phone](https://github.com/panxingfeng/Stable-Diddusion-on-phone/tree/master))），
