...
class QwenClient_0_5B:
    """
    调用本地部署的Qwen2.5-0.5B大模型，模型的配置信息在config/config.py中
    示例模板: messages = [
    ...
    """
    def __init__(self, model_path="Qwen/Qwen2.5-0.5B-Instruct", cache_dir="../../model"):
